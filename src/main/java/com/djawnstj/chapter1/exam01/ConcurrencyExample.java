...
public class ConcurrencyExample {
    public static void main(String[] args) {
        ...
        final int cupCores = Runtime.getRuntime().availableProcessors();
//        final int taskSize = cupCores * 2;
        final int taskSize = cupCores + 1;

        System.out.println("CPU 개수: " + cupCores + "개");
